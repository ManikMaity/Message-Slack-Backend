...
import { deleteChannelService, getChannelByIdService, updateChannelService } from "../services/channel.service.js";
...
export async function deleteChannelController(req, res) {
    try {
        ...
        res.status(StatusCodes.OK).json(customSuccessResponse("Channel deleted successfully", channel));
    }
    catch(err) {
        console.log(err);
        handleErrorRes(err, res);
...
export async function updateChannelController(req, res) {
    try {
        ...
        res.status(StatusCodes.OK).json(customSuccessResponse("Channel updated successfully", channel));
    }
    catch(err) {
        console.log(err);
        handleErrorRes(err, res);
